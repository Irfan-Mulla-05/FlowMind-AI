    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.3em] bg-clip-text text-transparent bg-gradient-to-r from-brand-300 to-cyan-400 font-bold">Powered by FlowMind AI</p>
      ...
      <section className="grid min-h-[80vh] items-center gap-12 py-16 lg:grid-cols-[1.2fr_0.8fr]">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          ...
          <h2 className="max-w-4xl font-display text-6xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-brand-100 to-brand-500 md:text-7xl pb-2 tracking-tight">
            Elevate your workflow with calm, focused execution.
          </h2>
          <p className="max-w-2xl text-lg leading-8 text-brand-100/80 font-light">
            Notion-inspired depth paired with practical AI planning, role-based insights,
            dynamic roadmaps, and an execution flow that stays simple when you need speed.
          </p>
